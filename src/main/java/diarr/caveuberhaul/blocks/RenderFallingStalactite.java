...
public class RenderFallingStalactite extends EntityRenderer<EntityFallingStalactite> {
    public RenderFallingStalactite() {
        this.shadowSize = 0.5F;
    }

    public void doRender(Tessellator tessellator, EntityFallingStalactite entity, double d, double d1, double d2, float f, float f1) {
        GL11.glPushMatrix();
