                        ...
                        for (int x = i - radius_int; x <= i + radius_int; x++) {
                            for (int z = k - radius_int; z <= k + radius_int; z++) {
                                ...
                                if (dist <= radius) {
                                    ...
                                    randModif = Math.round(UberUtil.clampedLerp(3, 1, (distModif), 1, 3));
                                    //h = (int) Math.round(Math.pow((radius - dist) * (0.9 - random.nextFloat() * 0.3f), 2) + random.nextInt(randModif));
                                    h = (int) Math.round(Math.pow((distModif) * (0.9 - random.nextFloat() * 0.3f), 2)*heightDif + random.nextInt(randModif));
